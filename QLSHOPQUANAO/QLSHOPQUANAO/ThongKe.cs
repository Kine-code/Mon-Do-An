...
namespace QLSHOPQUANAO
{
    public partial class ThongKe : Form
    {
        ...
        SqlConnection conn = new SqlConnection("Data Source=DESKTOP-2MC26TB\\CONGKIEN;Initial Catalog=SHOPQUANAO;Integrated Security=True");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                ThongKeHD rp = new ThongKeHD();
                rp.SetDataSource(laybang("SELECT cthoadon.sohd, cthoadon.masanpham, hoadon.ngaylap, hoadon.makh, cthoadon.dongia, cthoadon.soluong, cthoadon.tongtien FROM  cthoadon INNER JOIN hoadon ON cthoadon.sohd = hoadon.sohd WHERE cthoadon.sohd ='" + combo.Text.Trim()+"'"));
                crystalReportViewer1.ReportSource = rp;
            }
        }
        ...
        {
            if (txt_thang.Text.Trim() == "")
            {
                MessageBox.Show("Chọn Số Tháng!!");
                return;
            }
            ...
            DoanhThu1 rp = new DoanhThu1();
            rp.SetDataSource(dt);
            crystalReportViewer1.ReportSource = rp;
        }

        private void txt_hoadon_SelectedIndexChanged(object sender, EventArgs e)
        {
